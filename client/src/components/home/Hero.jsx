    ...
    <>
      <div className="px-[3%] xl:px-[5%] py-4 mx-auto relative z-50 mb-40 2xl:min-h-screen">
        ...
        <div className=" flex justify-center md:block">
          <button className="bg-[#3E3636] px-3 py-3 mt-8 text-white rounded-md">
            Explore Now
          </button>
        </div>
      </div>
      <svg
        className=" absolute right-0 top-[-10px] md:top-[-200px] xl:top-0 z-10 w-[240px] md:w-[55%] xl:h-[600px] 2xl:h-[833px]"
        viewBox="0 0 813 733"
        fill="none"
